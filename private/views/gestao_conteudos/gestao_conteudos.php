                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="titulo_inicio" name="titulo_inicio"
                                        value="Sistema Web de Apoio ao Inventário Hospitalar">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="texto_inicio" name="texto_inicio"
                                        rows="4">A MedInventário ajuda instituições de saúde a organizar, consultar e controlar equipamentos médicos de forma simples, centralizada e segura.</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="imagem_inicio" name="imagem_inicio"
                                        value="../assets/img/hospital-digital.png">
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="texto_seccao1" name="texto_seccao1"
                                        rows="5">A MedInventário é uma solução digital pensada para apoiar hospitais e serviços de saúde na gestão organizada do seu parque tecnológico.
...
A plataforma centraliza informação essencial sobre equipamentos, fornecedores, localizações, documentação, garantias e contratos, facilitando o acesso rápido aos dados.</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="imagem_seccao1" name="imagem_seccao1"
                                        value="../assets/img/equipa-biomedica.png">
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="texto_seccao2" name="texto_seccao2"
                                        rows="5">O objetivo da MedInventário é disponibilizar uma plataforma organizada para apoiar o ciclo de vida dos equipamentos médicos, desde o registo inicial até à sua consulta, atualização ou desativação.
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="titulo_funcionalidades"
                                        name="titulo_funcionalidades" value="Funcionalidades">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="texto_funcionalidades"
                                        ...
                                        rows="4">A MedInventário organiza os principais módulos necessários para uma gestão clara, simples e centralizada do inventário hospitalar.</textarea>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="icone_funcionalidade_1"
                                            name="icone_funcionalidade_1" value="fas fa-laptop-medical">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="titulo_funcionalidade_1"
                                            name="titulo_funcionalidade_1" value="Equipamentos">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="texto_funcionalidade_1"
                                            ...
                                            value="Registo, consulta e atualização dos equipamentos médicos existentes.">
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="icone_funcionalidade_2"
                                            name="icone_funcionalidade_2" value="fas fa-location-dot">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="titulo_funcionalidade_2"
                                            name="titulo_funcionalidade_2" value="Localizações">
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="icone_funcionalidade_3"
                                            name="icone_funcionalidade_3" value="fas fa-truck-medical">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="titulo_funcionalidade_3"
                                            name="titulo_funcionalidade_3" value="Fornecedores">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="texto_funcionalidade_3"
                                            ...
                                            value="Gestão de empresas, contactos e associações aos equipamentos.">
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="icone_funcionalidade_4"
                                            name="icone_funcionalidade_4" value="fas fa-file-medical">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="titulo_funcionalidade_4"
                                            name="titulo_funcionalidade_4" value="Documentação">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="texto_funcionalidade_4"
                                            ...
                                            value="Organização de manuais, certificados e documentos técnicos.">
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="icone_funcionalidade_5"
                                            name="icone_funcionalidade_5" value="fas fa-file-contract">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="titulo_funcionalidade_5"
                                            name="titulo_funcionalidade_5" value="Garantias">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="texto_funcionalidade_5"
                                            ...
                                            value="Consulta de garantias, contratos e entidades responsáveis.">
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="icone_funcionalidade_6"
                                            name="icone_funcionalidade_6" value="fas fa-chart-simple">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="titulo_funcionalidade_6"
                                            name="titulo_funcionalidade_6" value="Dashboard">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="texto_funcionalidade_6"
                                            ...
                                            value="Indicadores, alertas e resumo do estado do inventário.">
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="titulo_seccao4" name="titulo_seccao4"
                                        value="Informação centralizada para melhor decisão">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="texto_seccao4" name="texto_seccao4"
                                        rows="5">Através de indicadores e alertas, a solução permite identificar equipamentos críticos, garantias próximas do fim, documentação em falta e estados de funcionamento.
...
Esta informação ajuda os serviços técnicos e administrativos a acompanhar o inventário de forma mais rápida e estruturada.</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="imagem_seccao4" name="imagem_seccao4"
                                        value="../assets/img/dashboard.png">
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="cidade_pais_footer"
                                            name="cidade_pais_footer" value="Porto, Portugal">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="codigo_postal_footer"
                                            name="codigo_postal_footer" value="4249-000">
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="horario_semana_footer"
                                        name="horario_semana_footer" value="Segunda a sexta: 09:00 - 18:00">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="horario_sabado_footer"
                                        name="horario_sabado_footer" value="Sábado: 09:00 - 13:00">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="horario_domingo_footer"
                                        name="horario_domingo_footer" value="Domingo: encerrado">
                                </div>
